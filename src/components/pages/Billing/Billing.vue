        ...
        <div class="payment-details__content">
          ...
          <div class="payment-details__content-inner">
            ...
            <div class="payment-details__block">
              ...
              <p class="payment-details__balance-amount">
                {{ billing.currencySymbol }}{{ billing.balance }}</p>
            ...
            <table class="billing-history__list">
              ...
              <tbody>
                <Bill v-for="(bill, index) in billing.billingHistory" :bill="bill"
                   :index="index" :lastIndex="billing.billingHistory.length - 1" 
                   :currencySymbol="billing.currencySymbol" :key="bill.reference"></Bill>
              </tbody>
            </table>
          </div>
  ...
  mounted() {
    fetch("./data/data.json")
      ...
      .then((data) => {
        ...
        // Change date format and change balance and amount to floats
